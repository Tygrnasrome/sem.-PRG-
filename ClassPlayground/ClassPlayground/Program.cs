...
namespace ClassPlayground
{
    internal class Program
    {
        ...
        {
			//Rectangle obdelnik = new Rectangle(10, 10);
			//obdelnik.CalculateArea();
			//obdelnik.CalculateAspectRation();
			//obdelnik.ContainsPoint(1, 3);
			//obdelnik.ContainsPoint(7, 13);

			//Circle kruh = new Circle(10);
			//kruh.CalculateArea();
			//kruh.ContainsPoint(1, 3);
			//kruh.ContainsPoint(7, 13);
			Student Igor = new Student("Igor", 2025);
			Igor.AddSubject("matika");
			Igor.AddSubject("skibidi zachodovani");
			Igor.AddSubject("brain rotting");
			Igor.AddGrade(1, "brain rotting");
			Igor.AddGrade(1, "brain rotting");
			Igor.AddGrade(1, "brain rotting");
			Igor.AddGrade(5, "brain rotting",10);
			Igor.AddGrade(1, "skibidi zachodovani");
			Igor.AddGrade(3,"matika");
			Igor.CalculateSubjectGrade("brain rotting");
			Igor.CaculateTotalGrade();
			Console.ReadKey();
        }
    }
}
